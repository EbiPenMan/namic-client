...
cc.Class({
    ...
    runEffect: function () {
        ...
        this._first_Init_Value = this.effectTaget.opacity;

        this._fill_Start_Values();
        this._fill_End_Values();

        this._startValueTemp = this._startValueRelative;
        this.effectTaget.opacity = this._startValueTemp;
    ...
    _fill_Start_Values: function () {
        ...
        if (this.startValueType === baseEffectDefined.enValueTypeNoPredefined.Current) {
            ...
            this._startValueRelative = this.startValueNode.opacity;
        }

        // Calc Increase
        this._startValueRelative += this.startValueIncrease;

        this.effectTaget.opacity = this._startValueRelative;
    ...
    _fill_End_Values: function () {
        ...
        if (this.endValueType === baseEffectDefined.enValueTypeNoPredefined.Current) {
            ...
            this._endValueRelative = this.endValueNode.opacity;
        }
        ...
        let Action = cc.sequence(
            ...
            cc.callFunc(function () {
                ...
                if (self.loopType === baseEffectDefined.enLoopType.Restart) {
                    self.effectTaget.opacity = self._startValueRelative;
                }
            }),

            //effect
            cc.fadeTo(self.effectDuration, self._endValueTemp).easing(self._getCurrentEaseObject()),
    ...
    _reCalcValuesLoop: function () {
        ...
        if (self.loopType === baseEffectDefined.enLoopType.PingPong) {
            ...
            self._endValueTemp = self.effectTaget.opacity + self.endValue;
        }
    },
